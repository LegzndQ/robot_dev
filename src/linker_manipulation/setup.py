...
setup(
    ...
    data_files=[
        ...
        (f"share/{package_name}/config/camera", glob("config/camera/*.yaml")),
    ...
    entry_points={
        "console_scripts": [
            ...
            "intrinsic_calibrator_node = linker_manipulation.intrinsic_calibrator_node:main",
            "eye_to_hand_calibrator_node = linker_manipulation.eye_to_hand_calibrator_node:main",
            "camera_extrinsics_node = linker_manipulation.camera_extrinsics_node:main",
            "charuco_board_generator = linker_manipulation.charuco_board_generator:main",
